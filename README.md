...
* [mastodon](https://github.com/tootsuite/mastodon) ⭐ 50,297 | 🐛 4,532 | 🌐 Ruby | 📅 2026-09-14 - Self-hosted, globally interconnected microblogging community.
* [tg](https://github.com/vysheng/tg) ⭐ 7,192 | 🐛 1,186 | 🌐 C | 📅 2024-04-23 - Command Line Telegram.
...
* [Minikube](https://github.com/kubernetes/minikube) ⭐ 32,128 | 🐛 569 | 🌐 Go | 📅 2026-09-12 - Run Kubernetes locally.
...
* [nnn](https://github.com/jarun/nnn) ⭐ 21,881 | 🐛 6 | 🌐 C | 📅 2026-09-09 - The missing terminal file browser.
...
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,050 | 🐛 66 | 🌐 Rust | 📅 2026-09-14 - A command-line Git information tool written in Rust.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,300 | 🐛 232 | 🌐 Go | 📅 2026-09-14 - Render markdown on the CLI, with pizzazz! 💅🏻
* [mdp](https://github.com/visit1985/mdp) ⭐ 5,278 | 🐛 7 | 🌐 C | 📅 2026-09-09 - Markdown presentation tool.

### Miscellaneous

* [genact](https://github.com/svenstaro/genact) ⭐ 12,190 | 🐛 16 | 🌐 Rust | 📅 2026-09-01 - A nonsense activity generator
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 191,067 | 🐛 2,653 | 🌐 Python | 📅 2026-08-30 - Download videos from YouTube.com and other video sites.
* [Croc](https://github.com/schollz/croc) ⭐ 40,326 | 🐛 2 | 🌐 Go | 📅 2026-09-14 - Securely send things from one computer to another.
* [homebridge](https://github.com/nfarina/homebridge) ⭐ 25,489 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-30 - HomeKit support for the impatient.
* [Transfer](https://github.com/dutchcoders/transfer.sh) ⭐ 15,894 | 🐛 62 | 🌐 Go | 📅 2026-06-13 - Easy file sharing from the command line.
* [lychee](https://github.com/lycheeverse/lychee) ⭐ 3,913 | 🐛 80 | 🌐 Rust | 📅 2026-09-14 - Link checker written in Rust
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,252 | 🐛 195 | 🌐 Rust | 📅 2026-08-04 - Combines the usability of The Silver Searcher with the raw speed of grep.
...
* [powershell](https://github.com/powershell/powershell) ⭐ 55,381 | 🐛 1,629 | 🌐 C# | 📅 2026-09-11 -  Microsoft PowerShell.
* [Nu Shell](https://github.com/nushell/nushell) ⭐ 40,502 | 🐛 1,440 | 🌐 Rust | 📅 2026-09-14 - A modern shell for the GitHub era.
...
* [alacritty](https://github.com/jwilm/alacritty) ⭐ 65,718 | 🐛 341 | 🌐 Rust | 📅 2026-08-31 - A cross-platform, GPU-accelerated terminal emulator.
* [bat](https://github.com/sharkdp/bat) ⭐ 60,448 | 🐛 519 | 🌐 Rust | 📅 2026-09-04 - OSS cat replacement.
* [fd](https://github.com/sharkdp/fd) ⭐ 44,403 | 🐛 206 | 🌐 Rust | 📅 2026-09-09 - Simple, fast and user-friendly alternative to find.
* [upterm](https://github.com/railsware/upterm) ⚠️ Archived - A terminal emulator for the 21st century.
* [navi](https://github.com/denisidoro/navi) ⭐ 17,543 | 🐛 113 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line.
* [lsd](https://github.com/Peltoche/lsd) ⭐ 16,217 | 🐛 207 | 🌐 Rust | 📅 2026-08-17 - The next gen ls command.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,019 | 🐛 106 | 🌐 Rust | 📅 2026-09-13 - Yet another cross-platform graphical process/system monitor.
...
* [Ciphey](https://github.com/Ciphey/Ciphey) ⭐ 21,612 | 🐛 6 | 🌐 Rust | 📅 2026-09-14 - Decrypt data without knowing the key or cipher. Uses ML.
* [vuls](https://github.com/future-architect/vuls) ⭐ 12,255 | 🐛 91 | 🌐 Go | 📅 2026-09-14 - Go-based, agentless vulnerability scanner.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,977 | 🐛 328 | 🌐 Go | 📅 2026-09-14 - A command-line fuzzy finder written in Go.
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,458 | 🐛 146 | 🌐 Rust | 📅 2026-09-08 - A faster way to navigate your filesystem.
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,300 | 🐛 232 | 🌐 Go | 📅 2026-09-14 - Render markdown on the CLI, with pizzazz!
* [mas-cli](https://github.com/mas-cli/mas) ⭐ 12,348 | 🐛 87 | 🌐 Swift | 📅 2026-09-14 - Mac App Store command line interface.
* [shiori](https://github.com/RadhiFadlillah/shiori) ⭐ 11,640 | 🐛 119 | 🌐 Go | 📅 2026-07-10 - Shiori is a simple bookmarks manager written in Go.
* [progress](https://github.com/Xfennec/progress) ⭐ 8,858 | 🐛 66 | 🌐 C | 📅 2024-11-19 - Tool to show progress for cp, mv, dd.
* [Conky](https://github.com/brndnmtthws/conky) ⭐ 8,510 | 🐛 98 | 🌐 C++ | 📅 2026-08-07 - Light-weight system monitor for X.
* [finicky](https://github.com/johnste/finicky) ⭐ 5,091 | 🐛 49 | 🌐 Go | 📅 2026-09-04 - Customize which browser to start.
...
* [LazyGit](https://github.com/jesseduffield/lazygit) ⭐ 82,322 | 🐛 1,031 | 🌐 Go | 📅 2026-09-14 - Simple terminal UI for git commands.
* [Refined](https://github.com/sindresorhus/refined-github) ⭐ 32,159 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-14 - Browser extension that simplifies the GitHub interface.
* [dolt](https://github.com/dolthub/dolt) ⭐ 24,436 | 🐛 606 | 🌐 Go | 📅 2026-09-12 - It's Git for Data.
* [ungit](https://github.com/FredrikNoren/ungit) ⭐ 10,602 | 🐛 238 | 🌐 JavaScript | 📅 2026-09-03 - The easiest way to use git.
...
* [Annie](https://github.com/iawia002/annie) ⭐ 31,675 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - a fast, simple and clean video downloader.
