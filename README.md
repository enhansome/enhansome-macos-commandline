...
[Awesome Sysadmin](https://github.com/kahun/awesome-sysadmin) ⭐ 24,339 | 🐛 273 | 📅 2024-03-26.
...
* [Rsync Time](https://github.com/laurent22/rsync-time-backup) ⭐ 3,608 | 🐛 114 | 🌐 Shell | 📅 2025-05-27 - Time Machine style backup with rsync.
...
* [mastodon](https://github.com/tootsuite/mastodon) ⭐ 50,307 | 🐛 4,570 | 🌐 Ruby | 📅 2026-09-21 - Self-hosted, globally interconnected microblogging community.
* [tg](https://github.com/vysheng/tg) ⭐ 7,203 | 🐛 1,187 | 🌐 C | 📅 2024-04-23 - Command Line Telegram.
...
* [Minikube](https://github.com/kubernetes/minikube) ⭐ 32,147 | 🐛 601 | 🌐 Go | 📅 2026-09-20 - Run Kubernetes locally.
...
* [nnn](https://github.com/jarun/nnn) ⭐ 21,978 | 🐛 2 | 🌐 C | 📅 2026-09-19 - The missing terminal file browser.
* [ranger](https://github.com/ranger/ranger) ⭐ 17,408 | 🐛 897 | 🌐 Python | 📅 2026-09-09 - A console file manager with VI key bindings.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,408 | 🐛 236 | 🌐 Go | 📅 2026-09-14 - Render markdown on the CLI, with pizzazz! 💅🏻
* [mdp](https://github.com/visit1985/mdp) ⭐ 5,279 | 🐛 7 | 🌐 C | 📅 2026-09-09 - Markdown presentation tool.

### Miscellaneous

* [genact](https://github.com/svenstaro/genact) ⭐ 12,200 | 🐛 16 | 🌐 Rust | 📅 2026-09-01 - A nonsense activity generator
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 192,455 | 🐛 2,663 | 🌐 Python | 📅 2026-09-16 - Download videos from YouTube.com and other video sites.
* [Croc](https://github.com/schollz/croc) ⭐ 40,402 | 🐛 2 | 🌐 Go | 📅 2026-09-20 - Securely send things from one computer to another.
* [homebridge](https://github.com/nfarina/homebridge) ⭐ 25,496 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-30 - HomeKit support for the impatient.
* [Transfer](https://github.com/dutchcoders/transfer.sh) ⭐ 15,898 | 🐛 62 | 🌐 Go | 📅 2026-06-13 - Easy file sharing from the command line.
* [lychee](https://github.com/lycheeverse/lychee) ⭐ 3,922 | 🐛 72 | 🌐 Rust | 📅 2026-09-21 - Link checker written in Rust
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,487 | 🐛 200 | 🌐 Rust | 📅 2026-08-04 - Combines the usability of The Silver Searcher with the raw speed of grep.
...
* [powershell](https://github.com/powershell/powershell) ⭐ 55,470 | 🐛 1,599 | 🌐 C# | 📅 2026-09-20 -  Microsoft PowerShell.
* [Nu Shell](https://github.com/nushell/nushell) ⭐ 40,543 | 🐛 1,434 | 🌐 Rust | 📅 2026-09-21 - A modern shell for the GitHub era.
...
* [alacritty](https://github.com/jwilm/alacritty) ⭐ 65,779 | 🐛 342 | 🌐 Rust | 📅 2026-08-31 - A cross-platform, GPU-accelerated terminal emulator.
* [bat](https://github.com/sharkdp/bat) ⭐ 60,525 | 🐛 518 | 🌐 Rust | 📅 2026-09-04 - OSS cat replacement.
* [fd](https://github.com/sharkdp/fd) ⭐ 44,502 | 🐛 198 | 🌐 Rust | 📅 2026-09-20 - Simple, fast and user-friendly alternative to find.
* [upterm](https://github.com/railsware/upterm) ⚠️ Archived - A terminal emulator for the 21st century.
* [navi](https://github.com/denisidoro/navi) ⭐ 17,599 | 🐛 110 | 🌐 Rust | 📅 2026-09-20 - An interactive cheatsheet tool for the command-line.
* [lsd](https://github.com/Peltoche/lsd) ⭐ 16,235 | 🐛 210 | 🌐 Rust | 📅 2026-08-17 - The next gen ls command.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,040 | 🐛 105 | 🌐 Rust | 📅 2026-09-18 - Yet another cross-platform graphical process/system monitor.
...
* [Ciphey](https://github.com/Ciphey/Ciphey) ⭐ 21,622 | 🐛 12 | 🌐 Rust | 📅 2026-09-18 - Decrypt data without knowing the key or cipher. Uses ML.
* [vuls](https://github.com/future-architect/vuls) ⭐ 12,265 | 🐛 92 | 🌐 Go | 📅 2026-09-19 - Go-based, agentless vulnerability scanner.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,169 | 🐛 330 | 🌐 Go | 📅 2026-09-14 - A command-line fuzzy finder written in Go.
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,637 | 🐛 146 | 🌐 Rust | 📅 2026-09-14 - A faster way to navigate your filesystem.
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,408 | 🐛 236 | 🌐 Go | 📅 2026-09-14 - Render markdown on the CLI, with pizzazz!
* [mas-cli](https://github.com/mas-cli/mas) ⭐ 12,357 | 🐛 87 | 🌐 Swift | 📅 2026-09-21 - Mac App Store command line interface.
* [shiori](https://github.com/RadhiFadlillah/shiori) ⭐ 11,644 | 🐛 119 | 🌐 Go | 📅 2026-07-10 - Shiori is a simple bookmarks manager written in Go.
* [progress](https://github.com/Xfennec/progress) ⭐ 8,854 | 🐛 66 | 🌐 C | 📅 2024-11-19 - Tool to show progress for cp, mv, dd.
* [Conky](https://github.com/brndnmtthws/conky) ⭐ 8,519 | 🐛 98 | 🌐 C++ | 📅 2026-08-07 - Light-weight system monitor for X.
* [finicky](https://github.com/johnste/finicky) ⭐ 5,108 | 🐛 54 | 🌐 Go | 📅 2026-09-16 - Customize which browser to start.
* [trash-cli](https://github.com/andreafrancia/trash-cli) ⭐ 4,593 | 🐛 84 | 🌐 Python | 📅 2026-09-15 - Command line interface to the freedesktop.org trashcan.
...
* [LazyGit](https://github.com/jesseduffield/lazygit) ⭐ 82,549 | 🐛 1,049 | 🌐 Go | 📅 2026-09-21 - Simple terminal UI for git commands.
* [Refined](https://github.com/sindresorhus/refined-github) ⭐ 32,192 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-20 - Browser extension that simplifies the GitHub interface.
* [dolt](https://github.com/dolthub/dolt) ⭐ 24,482 | 🐛 579 | 🌐 Go | 📅 2026-09-21 - It's Git for Data.
