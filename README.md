...
[Awesome Sysadmin](https://github.com/kahun/awesome-sysadmin) ⭐ 24,339 | 🐛 272 | 📅 2024-03-26.
...
* [mastodon](https://github.com/tootsuite/mastodon) ⭐ 50,303 | 🐛 4,556 | 🌐 Ruby | 📅 2026-09-19 - Self-hosted, globally interconnected microblogging community.
...
* [Minikube](https://github.com/kubernetes/minikube) ⭐ 32,140 | 🐛 602 | 🌐 Go | 📅 2026-09-18 - Run Kubernetes locally.
...
* [nnn](https://github.com/jarun/nnn) ⭐ 21,946 | 🐛 1 | 🌐 C | 📅 2026-09-16 - The missing terminal file browser.
...
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,048 | 🐛 63 | 🌐 Rust | 📅 2026-09-18 - A command-line Git information tool written in Rust.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,382 | 🐛 235 | 🌐 Go | 📅 2026-09-14 - Render markdown on the CLI, with pizzazz! 💅🏻
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 192,068 | 🐛 2,659 | 🌐 Python | 📅 2026-09-16 - Download videos from YouTube.com and other video sites.
* [Croc](https://github.com/schollz/croc) ⭐ 40,378 | 🐛 8 | 🌐 Go | 📅 2026-09-18 - Securely send things from one computer to another.
* [homebridge](https://github.com/nfarina/homebridge) ⭐ 25,495 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-30 - HomeKit support for the impatient.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,430 | 🐛 199 | 🌐 Rust | 📅 2026-08-04 - Combines the usability of The Silver Searcher with the raw speed of grep.
...
* [powershell](https://github.com/powershell/powershell) ⭐ 55,452 | 🐛 1,595 | 🌐 C# | 📅 2026-09-18 -  Microsoft PowerShell.
* [Nu Shell](https://github.com/nushell/nushell) ⭐ 40,526 | 🐛 1,439 | 🌐 Rust | 📅 2026-09-18 - A modern shell for the GitHub era.
...
* [alacritty](https://github.com/jwilm/alacritty) ⭐ 65,761 | 🐛 340 | 🌐 Rust | 📅 2026-08-31 - A cross-platform, GPU-accelerated terminal emulator.
* [bat](https://github.com/sharkdp/bat) ⭐ 60,501 | 🐛 518 | 🌐 Rust | 📅 2026-09-04 - OSS cat replacement.
* [fd](https://github.com/sharkdp/fd) ⭐ 44,482 | 🐛 201 | 🌐 Rust | 📅 2026-09-16 - Simple, fast and user-friendly alternative to find.
* [upterm](https://github.com/railsware/upterm) ⚠️ Archived - A terminal emulator for the 21st century.
* [navi](https://github.com/denisidoro/navi) ⭐ 17,568 | 🐛 112 | 🌐 Rust | 📅 2026-09-15 - An interactive cheatsheet tool for the command-line.
* [lsd](https://github.com/Peltoche/lsd) ⭐ 16,233 | 🐛 208 | 🌐 Rust | 📅 2026-08-17 - The next gen ls command.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,033 | 🐛 104 | 🌐 Rust | 📅 2026-09-18 - Yet another cross-platform graphical process/system monitor.
...
* [Ciphey](https://github.com/Ciphey/Ciphey) ⭐ 21,621 | 🐛 9 | 🌐 Rust | 📅 2026-09-18 - Decrypt data without knowing the key or cipher. Uses ML.
* [vuls](https://github.com/future-architect/vuls) ⭐ 12,263 | 🐛 92 | 🌐 Go | 📅 2026-09-19 - Go-based, agentless vulnerability scanner.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,126 | 🐛 329 | 🌐 Go | 📅 2026-09-14 - A command-line fuzzy finder written in Go.
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,573 | 🐛 146 | 🌐 Rust | 📅 2026-09-14 - A faster way to navigate your filesystem.
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,382 | 🐛 235 | 🌐 Go | 📅 2026-09-14 - Render markdown on the CLI, with pizzazz!
* [mas-cli](https://github.com/mas-cli/mas) ⭐ 12,355 | 🐛 87 | 🌐 Swift | 📅 2026-09-14 - Mac App Store command line interface.
...
* [Conky](https://github.com/brndnmtthws/conky) ⭐ 8,514 | 🐛 99 | 🌐 C++ | 📅 2026-08-07 - Light-weight system monitor for X.
* [finicky](https://github.com/johnste/finicky) ⭐ 5,105 | 🐛 53 | 🌐 Go | 📅 2026-09-16 - Customize which browser to start.
...
* [LazyGit](https://github.com/jesseduffield/lazygit) ⭐ 82,472 | 🐛 1,033 | 🌐 Go | 📅 2026-09-19 - Simple terminal UI for git commands.
* [Refined](https://github.com/sindresorhus/refined-github) ⭐ 32,182 | 🐛 82 | 🌐 TypeScript | 📅 2026-09-19 - Browser extension that simplifies the GitHub interface.
* [dolt](https://github.com/dolthub/dolt) ⭐ 24,470 | 🐛 579 | 🌐 Go | 📅 2026-09-18 - It's Git for Data.
...
* [Annie](https://github.com/iawia002/annie) ⭐ 31,690 | 🐛 545 | 🌐 Go | 📅 2026-03-29 - a fast, simple and clean video downloader.
