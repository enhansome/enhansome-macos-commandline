...
[Awesome Sysadmin](https://github.com/kahun/awesome-sysadmin) ⭐ 24,338 | 🐛 273 | 📅 2024-03-26.
...
* [mastodon](https://github.com/tootsuite/mastodon) ⭐ 50,306 | 🐛 4,559 | 🌐 Ruby | 📅 2026-09-20 - Self-hosted, globally interconnected microblogging community.
* [tg](https://github.com/vysheng/tg) ⭐ 7,202 | 🐛 1,187 | 🌐 C | 📅 2024-04-23 - Command Line Telegram.
...
* [Minikube](https://github.com/kubernetes/minikube) ⭐ 32,141 | 🐛 600 | 🌐 Go | 📅 2026-09-19 - Run Kubernetes locally.
...
* [nnn](https://github.com/jarun/nnn) ⭐ 21,962 | 🐛 2 | 🌐 C | 📅 2026-09-19 - The missing terminal file browser.
* [ranger](https://github.com/ranger/ranger) ⭐ 17,405 | 🐛 896 | 🌐 Python | 📅 2026-09-09 - A console file manager with VI key bindings.
...
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,048 | 🐛 63 | 🌐 Rust | 📅 2026-09-20 - A command-line Git information tool written in Rust.
...
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,391 | 🐛 236 | 🌐 Go | 📅 2026-09-14 - Render markdown on the CLI, with pizzazz! 💅🏻
* [mdp](https://github.com/visit1985/mdp) ⭐ 5,279 | 🐛 7 | 🌐 C | 📅 2026-09-09 - Markdown presentation tool.

### Miscellaneous

* [genact](https://github.com/svenstaro/genact) ⭐ 12,197 | 🐛 16 | 🌐 Rust | 📅 2026-09-01 - A nonsense activity generator
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 192,248 | 🐛 2,663 | 🌐 Python | 📅 2026-09-16 - Download videos from YouTube.com and other video sites.
* [Croc](https://github.com/schollz/croc) ⭐ 40,391 | 🐛 9 | 🌐 Go | 📅 2026-09-18 - Securely send things from one computer to another.
* [homebridge](https://github.com/nfarina/homebridge) ⭐ 25,495 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-30 - HomeKit support for the impatient.
* [Transfer](https://github.com/dutchcoders/transfer.sh) ⭐ 15,899 | 🐛 62 | 🌐 Go | 📅 2026-06-13 - Easy file sharing from the command line.
* [lychee](https://github.com/lycheeverse/lychee) ⭐ 3,921 | 🐛 82 | 🌐 Rust | 📅 2026-09-14 - Link checker written in Rust
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,463 | 🐛 201 | 🌐 Rust | 📅 2026-08-04 - Combines the usability of The Silver Searcher with the raw speed of grep.
...
* [powershell](https://github.com/powershell/powershell) ⭐ 55,459 | 🐛 1,599 | 🌐 C# | 📅 2026-09-18 -  Microsoft PowerShell.
* [Nu Shell](https://github.com/nushell/nushell) ⭐ 40,529 | 🐛 1,439 | 🌐 Rust | 📅 2026-09-19 - A modern shell for the GitHub era.
...
* [alacritty](https://github.com/jwilm/alacritty) ⭐ 65,764 | 🐛 341 | 🌐 Rust | 📅 2026-08-31 - A cross-platform, GPU-accelerated terminal emulator.
* [bat](https://github.com/sharkdp/bat) ⭐ 60,508 | 🐛 518 | 🌐 Rust | 📅 2026-09-04 - OSS cat replacement.
* [fd](https://github.com/sharkdp/fd) ⭐ 44,492 | 🐛 198 | 🌐 Rust | 📅 2026-09-20 - Simple, fast and user-friendly alternative to find.
* [upterm](https://github.com/railsware/upterm) ⚠️ Archived - A terminal emulator for the 21st century.
* [navi](https://github.com/denisidoro/navi) ⭐ 17,577 | 🐛 110 | 🌐 Rust | 📅 2026-09-20 - An interactive cheatsheet tool for the command-line.
* [lsd](https://github.com/Peltoche/lsd) ⭐ 16,235 | 🐛 209 | 🌐 Rust | 📅 2026-08-17 - The next gen ls command.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,035 | 🐛 105 | 🌐 Rust | 📅 2026-09-18 - Yet another cross-platform graphical process/system monitor.
...
* [Ciphey](https://github.com/Ciphey/Ciphey) ⭐ 21,621 | 🐛 12 | 🌐 Rust | 📅 2026-09-18 - Decrypt data without knowing the key or cipher. Uses ML.
* [vuls](https://github.com/future-architect/vuls) ⭐ 12,264 | 🐛 92 | 🌐 Go | 📅 2026-09-19 - Go-based, agentless vulnerability scanner.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,148 | 🐛 330 | 🌐 Go | 📅 2026-09-14 - A command-line fuzzy finder written in Go.
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,615 | 🐛 146 | 🌐 Rust | 📅 2026-09-14 - A faster way to navigate your filesystem.
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,391 | 🐛 236 | 🌐 Go | 📅 2026-09-14 - Render markdown on the CLI, with pizzazz!
* [mas-cli](https://github.com/mas-cli/mas) ⭐ 12,356 | 🐛 87 | 🌐 Swift | 📅 2026-09-14 - Mac App Store command line interface.
...
* [progress](https://github.com/Xfennec/progress) ⭐ 8,856 | 🐛 66 | 🌐 C | 📅 2024-11-19 - Tool to show progress for cp, mv, dd.
* [Conky](https://github.com/brndnmtthws/conky) ⭐ 8,515 | 🐛 99 | 🌐 C++ | 📅 2026-08-07 - Light-weight system monitor for X.
* [finicky](https://github.com/johnste/finicky) ⭐ 5,106 | 🐛 53 | 🌐 Go | 📅 2026-09-16 - Customize which browser to start.
* [trash-cli](https://github.com/andreafrancia/trash-cli) ⭐ 4,592 | 🐛 83 | 🌐 Python | 📅 2026-09-15 - Command line interface to the freedesktop.org trashcan.
* [fDupes](https://github.com/adrianlopezroche/fdupes) ⭐ 3,013 | 🐛 95 | 🌐 C | 📅 2026-04-14 - Identifying and/or deleting duplicate files.
* [cpufetch](https://github.com/Dr-Noob/cpufetch) ⭐ 2,147 | 🐛 132 | 🌐 C | 📅 2025-11-01 - Simple yet fancy CPU architecture fetching tool.
...
* [LazyGit](https://github.com/jesseduffield/lazygit) ⭐ 82,523 | 🐛 1,041 | 🌐 Go | 📅 2026-09-20 - Simple terminal UI for git commands.
* [Refined](https://github.com/sindresorhus/refined-github) ⭐ 32,186 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-20 - Browser extension that simplifies the GitHub interface.
* [dolt](https://github.com/dolthub/dolt) ⭐ 24,475 | 🐛 579 | 🌐 Go | 📅 2026-09-18 - It's Git for Data.
